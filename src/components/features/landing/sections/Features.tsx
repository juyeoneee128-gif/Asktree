...
const features: Feature[] = [
  {
    ...
    body: '터미널에 한 줄 설치하면, Claude Code 세션이 끝날 때마다\n코드 변경, 작업 내역, 기획서(docs/*.md)를 자동으로 수집합니다\n따로 업로드하거나 설정할 필요 없습니다',
    image: '/landing/screen-terminal.png',
    imageAlt: 'CLI 터미널 — 에이전트 로그',
  },
  {
    eyebrow: '02 · 세션 보관',
    title: '내 코딩 과정을 아카이빙합니다',
    body: '“이번 세션: 결제 모듈 추가, 인증 미들웨어 수정”\n세션마다 무엇을 했는지 자동으로 정리합니다\n코드를 몰라도 프로젝트의 현재 상태를 한눈에 파악할 수 있습니다',
    image: '/landing/screen-session.png',
    imageAlt: '세션 요약 화면',
  },
  {
    eyebrow: '03 · 이슈 감지',
    title: '보이지 않는 이슈를 먼저 알려줍니다',
    body: '빌드는 되지만 기능이 깨진 문제, 인증을 우회하는 위험한 코드\n같은 기능이 중복으로 만들어진 구조까지\n코드를 몰라도 문제의 심각도와 해결 방법을 바로 확인할 수 있습니다',
    image: '/landing/screen-issues.png',
    imageAlt: '이슈 탭 — Fact / Detail / Fix',
  },
  {
    eyebrow: '04 · 현황 트래킹',
    title: '기획 대비 어디까지 왔는지 한눈에',
    body: '기획서에 적은 기능이 실제로 얼마나 구현되었는지 자동 대조합니다\n구현률 바와 기능 목록으로 진행 상황을 시각화합니다',
    image: '/landing/screen-status.png',
    imageAlt: '현황 탭 — 구현률 + 기능 목록',
  },
  {
    eyebrow: '05 · 보호 규칙',
    title: '한 번 발생한 문제는 두 번 없도록',
    body: '감지된 문제를 CLAUDE.md 보호 규칙으로 자동 생성합니다\nAI가 같은 실수를 반복하지 않도록 활용해보세요',
    image: '/landing/screen-claude-md.png',
    imageAlt: 'CLAUDE.md 탭 — 보호 규칙',
  },
];
